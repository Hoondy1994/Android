...
#ifndef ULE_NAPI_INTERFACES_KITS_NAPI_NATIVE_COMMON_H
#define ULE_NAPI_INTERFACES_KITS_NAPI_NATIVE_COMMON_H
...
#endif /* ULE_NAPI_INTERFACES_KITS_NAPI_NATIVE_COMMON_H */
